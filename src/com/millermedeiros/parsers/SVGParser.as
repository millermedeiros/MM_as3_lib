...
package com.millermedeiros.parsers {
	...
	public final class SVGParser {
		 ...
		 * @return	Motifs array
		 */
		public static function toMotifs(svg:String):Array {
			...
			// WARNINGS / ERRORS
			if(_eWarnings.length) trace("WARNING: Elements ["+_eWarnings+ "] are not supported and will be ignored.");
			if(_aWarnings.length) trace("WARNING: Attributes ["+_aWarnings+ "] are not supported and will be ignored.");
			if(_pWarnings.length) trace("WARNING: Path drawing commands ["+_pWarnings+ "] are not supported and will be ignored.");
			if(_tWarnings.length) trace("WARNING: Transform commands ["+_tWarnings+ "] are not supported and will be ignored.");
